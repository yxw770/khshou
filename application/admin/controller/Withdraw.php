...
class Withdraw extends AdminBase
{
    public function index()
    {
        ...
        if (request()->isGet()) {
            ...
            if (isset($get['do']) && $get['do'] == 'search') {
                ...
                $usermentlist_arr = $userpayment_model->get_withdraw_by_condition_on_admin($condition);
        ...
        $assign_arr = array('title' => "用户提现", 'list' => $list, 'page' => $page,);
    ...
    public function editsave()
    {
        if (request()->isPost()) {
            ...
            $usermoney = $userpayment_model->get_value_by_condition_on_admin('usermoney', $condition);
            $load_arr['settlement'] = $usermoney;
