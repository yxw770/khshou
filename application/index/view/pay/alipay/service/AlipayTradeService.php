...
require_once APP_PATH_INDEX.'pay/'.$directory.'/AopSdk.php';
require APP_PATH_INDEX.'pay/'.$directory.'/config.php';
...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
            file_put_contents ( APP_PATH_INDEX.'pay/'."alipay"."/".date('Ymd')."_notify.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
